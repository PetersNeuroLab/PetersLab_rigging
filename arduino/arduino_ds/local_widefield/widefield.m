...
% video_object = videoinput( 'gentl', 1);
src = getselectedsource(video_object);

video_object.ReturnedColorSpace="grayscale"
video_object.FramesPerTrigger=Inf;
video_object.TriggerRepeat = Inf;


src.ExposureAuto="Off";
src.GainAuto="Off";
src.BlackLevelEnable="True";
...
gui_data.video_object.ROIPosition = [0,0,gui_data.video_object.VideoResolution];
...
gui_data.video_object.ROIPosition  = roi_position;
start(gui_data.video_object);
