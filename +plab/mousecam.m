...
switch h.Value
    case 1
        ...
        cam_start(gui_fig,save_filename);
...
function cam_start(gui_fig,save_filename)
% Start recording
...
% Create videowriter
[cam_path,cam_file] = fileparts(save_filename);
...
header_fn = fullfile(cam_path,[cam_file,'_header.bin']);
...
if strcmp(expcontroller_message, 'stop')
    ...
    save_filename = ...
        ...
        rec_info.mouse,rec_info.date,rec_info.time,'mousecam.mj2');
