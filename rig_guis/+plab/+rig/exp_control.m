...
recording_info = struct( ...
    'prepend_text',mouse+"_", ...
    'base_text',string(datetime('now','Format','yyyy-MM-dd')), ...
    'append_text','_ephys', ...
    'parent_directory',strrep(plab.locations.local_data_path,'C:','D:'), ...
...
%     error('Open Ephys: streams not synchronized')
%     return
% end
